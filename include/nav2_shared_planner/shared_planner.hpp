...
#ifndef NAV2_SHARED_PLANNER__SHARED_PLANNER_HPP_
#define NAV2_SHARED_PLANNER__SHARED_PLANNER_HPP_
...
class SharedPlanner : public nav2_core::GlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
   ...
   * @return TODO
   */
  void shared_cb(const nav_msgs::msg::Path::SharedPtr event);

  // Planner based on ROS1 Shared algorithm
  std::unique_ptr<Shared> planner_;
  ...
  // Logger
  rclcpp::Logger logger_{rclcpp::get_logger("SharedPlanner")};

  // Global Costmap
  nav2_costmap_2d::Costmap2D * costmap_;

  // The global frame of the costmap
  std::string global_frame_, name_, robot_frame_;
  ...
  rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr shared_publisher_;
  rclcpp::Subscription<nav_msgs::msg::Path>::SharedPtr shared_subscription_;
...
#endif  // NAV2_SHARED_PLANNER__SHARED_PLANNER_HPP_
